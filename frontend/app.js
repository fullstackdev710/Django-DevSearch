...
var addVoteEvents = function () {
    ...
    for (var i = 0; voteBtns.length > i; i++) {
        voteBtns[i].addEventListener('click', function (e) {
            var token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjc3MzcyNzAzLCJpYXQiOjE2NzcyODYzMDMsImp0aSI6ImYwZDJiYzc3OWMwYTQ4NjZhOGQ0ZTI1Yjc4N2NlMjdlIiwidXNlcl9pZCI6MX0.dfFIn0xVr78n050U3_NvuTdh_idR08VNTlfNm3jkYbc";
            var target = e.target;
