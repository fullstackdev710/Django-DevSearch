let loginBtn = document.getElementById("login-btn") as HTMLBodyElement;
let logoutBtn = document.getElementById("logout-btn") as HTMLBodyElement;
...
let buildProjects = (projects) => {
  let projectsWrapper = document.getElementById(
    "projects-wrapper"
  ) as HTMLBodyElement;
